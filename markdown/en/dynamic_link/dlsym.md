...
<p>
            dlsym retrieves the address of an exported function as an dlsym handle.</p>

<p>if symbolname not found, nelson try to find symbol equivalent based on these rules and in this order:</p>
