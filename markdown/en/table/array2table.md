...
By default,<b>array2table</b> uses the name of the input array, combined with the column number, to create variable names in the table. If these names are not valid identifiers, it assigns default names of the form<b>
'Var1', 'Var2', ... , 'VarN'
</b>, where <b>N</b> is the number of columns in <b>A</b>.
