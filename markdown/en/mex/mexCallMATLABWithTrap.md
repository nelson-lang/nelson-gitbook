...
<p>
            mexCallMATLABWithTrap calls an NELSON function and capture error.</p>

<p>If name detects an error, mexCallMATLABWithTrap returns an mxArray (MException object).</p>
