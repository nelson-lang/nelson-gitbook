...
<p>
            MX_IS_NELSON macro is defined to easily detect if Nelson is used in C code.</p>

<p>
                MX_HAS_INTERLEAVED_COMPLEX macro is defined if C MEX API used is '-R2018a'.</p>
...
<p>
                    -D The -D option defines C preprocessor macro.</p>

<p>
                        -U The -U option undefines C preprocessor macro</p>

<p>
                            -I Adds pathname to the list of folders to search for #include files.</p>

<p>
                                -l Links with dynamic object library .lib, .so or .dylib.</p>

<p>
                                    -g Used for debugging (Debug configuration).</p>
