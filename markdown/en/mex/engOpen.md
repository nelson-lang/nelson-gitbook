...
<p>
            engOpen starts a Nelson process for using Nelson as a computational engine.</p>
...
<p>on linux: export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:res
            </p>

<p>export PATH=$PATH:res
        </p>

<p>on macos: export DYLIB_LIBRARY_PATH=$DYLIB_LIBRARY_PATH:res
    </p>

<p>export PATH=$PATH:res
</p>

<p>on windows: set PATH=%PATH%;res
</p>
