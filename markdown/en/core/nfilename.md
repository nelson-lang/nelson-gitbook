...
<p>
            <b>R = nfilename()</b> returns the name of the currently executing file.</p>
<p>
                <b>nfilename()</b> called from outside an nlf file returns an empty string.</p>
...
<p>
                    <b>mfilename</b> is an alias on <b>nfilename</b> added for basic script compatibility.</p>
