...
<p>
            <b>quit</b> terminates current Nelson application.</p>
<p>
                <b>quit('cancel')</b> command is designed specifically for utilization within a finish.m script, preventing the termination process.</p>
