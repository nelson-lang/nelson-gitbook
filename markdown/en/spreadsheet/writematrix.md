...
<p>
            writematrix writes an numeric matrix to an CSV format file.</p>

<p>
                writematrix does not support sparse matrices.</p>

<p>
                    writematrix outputs numeric data in the long G format.</p>
