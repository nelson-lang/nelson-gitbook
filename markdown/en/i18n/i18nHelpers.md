...
<p>
            i18nHelpers provides essential utility functions for managing internationalization files. The main functions include:</p>

<p>- 'convert': Converts a .po/.pot translation template file into JSON format for easier manipulation.</p>

<p>- 'merge': Merges two JSON translation files. The entries from jsonFile1 are added to jsonFile2, and entries exclusive to jsonFile2 are removed.</p>

<p>- 'sort': Sorts and organizes entries in a JSON translation file. jsonFileA and jsonFileB may refer to the same file if in-place sorting is desired.</p>
