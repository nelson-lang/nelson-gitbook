...
<p>
        dlgeneratemake génère un makefile adapté à votre environnement pour construire des bibliothèques partagées.</p>

<p>Nelson s'appuie sur CMake pour cette tâche.</p>
