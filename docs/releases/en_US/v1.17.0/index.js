...
window.searchIndex = [
  ...
  },
  {
    ...
    content: "function argument validation block.",
  },
  {
    title: "break",
  ...
  },
  {
    ...
    content: "Add comments to Nelson code.",
  },
  {
    title: "continue",
  ...
  },
  {
    ...
    content: "Cleanup tasks upon function completion",
  },
  {
    title: "parsefile",
  ...
  },
  {
    ...
    content: "1-D data interpolation",
  },
  {
    title: "interp2",
    url: "./special_functions/interp2.html",
    path: "./special_functions/interp2.html",
    content: "Interpolation for 2-D gridded data in meshgrid format",
  },
  {
    title: "interp3",
    url: "./special_functions/interp3.html",
    path: "./special_functions/interp3.html",
    content: "Interpolation for 3-D gridded data in meshgrid format",
  },
  {
    title: "interpn",
    url: "./special_functions/interpn.html",
    path: "./special_functions/interpn.html",
    content: "Interpolation for N-D gridded data in ndgrid format",
  },
  {
    title: "peaks",
  ...
  },
  {
    ...
    content: "Determine array elements between lower and upper bounds.",
  },
  {
    title: "ismissing",
  ...
  },
  {
    ...
    content: "Root Mean Square (RMS) of array elements.",
  },
  {
    title: "sort",
  ...
  },
  {
    ...
    content: "Evaluate a piecewise polynomial form",
  },
  {
    title: "roots",
  ...
  },
  {
    ...
    content: "Returns list of current used audiorecorder handle.",
  },
  {
  ...
  },
  {
    ...
    content: "Store recorded audio signal in numeric array.",
  },
  {
    title: "getplayer",
    url: "./audio/getplayer.html",
    path: "./audio/getplayer.html",
    content: "Create associated audioplayer object.",
  },
  {
    title: "isplaying",
  ...
  },
  {
    ...
    content: "Determine if recording is in progress.",
  },
  {
    title: "lin2mu",
  ...
  },
  {
    ...
    content: "Record audio to audiorecorder object.",
  },
  {
  ...
  },
  {
    ...
    content: "Debugging workflow for Nelson code files.",
  },
  {
    title: "edit",
  ...
  },
  {
    ...
    content: "Contour matrix computation",
  },
  {
    title: "contourf",
    url: "./graphics/contourf.html",
    path: "./graphics/contourf.html",
    content: "Filled contour plot of matrix",
  },
  {
    title: "cylinder",
  ...
  },
  {
    ...
    content: "Control data unit length along each axis.",
  },
  {
    title: "drawnow",
  ...
  },
  {
    ...
    content: "Find graphics objects with specific properties.",
  },
  {
    title: "flag",
  ...
  },
  {
    ...
    content: "Create axes in tiled chart layout.",
  },
  {
    title: "pan",
  ...
  },
  {
    ...
    content: "Control relative lengths of each axis in the plot box.",
  },
  {
    title: "pcolor",
  ...
  },
  {
    ...
    content: "Create tiled chart layout.",
  },
  {
    title: "tilenum",
    url: "./graphics/tilenum.html",
    path: "./graphics/tilenum.html",
    content: "Get tile number from row-column indices or graphics object.",
  },
  {
    title: "tilerowcol",
    url: "./graphics/tilerowcol.html",
    path: "./graphics/tilerowcol.html",
    content: "Get row and column indices from tile number or graphics object.",
  },
  {
    title: "title",
  ...
  {
    title: "abyss",
    url: "./graphics/colormap/abyss.html",
    path: "./graphics/colormap/abyss.html",
    content: "Abyss colormap array.",
  },
  {
    title: "autumn",
    url: "./graphics/colormap/autumn.html",
    path: "./graphics/colormap/autumn.html",
    content: "Autumn colormap array.",
  },
  {
    title: "bone",
    url: "./graphics/colormap/bone.html",
    path: "./graphics/colormap/bone.html",
    content: "Bone colormap array.",
  },
  {
    title: "colormap",
    url: "./graphics/colormap/colormap.html",
    path: "./graphics/colormap/colormap.html",
    content: "View and set current colormap.",
  },
  {
    title: "colormaplist",
    url: "./graphics/colormap/colormaplist.html",
    path: "./graphics/colormap/colormaplist.html",
    content: "Provide list of colormaps.",
  },
  {
    title: "cool",
    url: "./graphics/colormap/cool.html",
    path: "./graphics/colormap/cool.html",
    content: "Cool colormap array.",
  },
  {
    title: "copper",
    url: "./graphics/colormap/copper.html",
    path: "./graphics/colormap/copper.html",
    content: "Copper colormap array.",
  },
  {
    title: "gray",
    url: "./graphics/colormap/gray.html",
    path: "./graphics/colormap/gray.html",
    content: "Gray colormap array.",
  },
  {
    title: "hot",
    url: "./graphics/colormap/hot.html",
    path: "./graphics/colormap/hot.html",
    content: "Hot colormap array.",
  },
  {
    title: "jet",
    url: "./graphics/colormap/jet.html",
    path: "./graphics/colormap/jet.html",
    content: "Jet colormap array.",
  },
  {
    title: "nebula",
    url: "./graphics/colormap/nebula.html",
    path: "./graphics/colormap/nebula.html",
    content: "Nebula colormap array.",
  },
  {
    title: "parula",
    url: "./graphics/colormap/parula.html",
    path: "./graphics/colormap/parula.html",
    content: "Parula colormap array.",
  },
  {
    title: "pink",
    url: "./graphics/colormap/pink.html",
    path: "./graphics/colormap/pink.html",
    content: "Pink colormap array.",
  },
  {
    title: "sky",
    url: "./graphics/colormap/sky.html",
    path: "./graphics/colormap/sky.html",
    content: "Sky colormap array.",
  },
  {
    title: "summer",
    url: "./graphics/colormap/summer.html",
    path: "./graphics/colormap/summer.html",
    content: "Summer colormap array.",
  },
  {
    title: "turbo",
    url: "./graphics/colormap/turbo.html",
    path: "./graphics/colormap/turbo.html",
    content: "Turbo colormap array.",
  },
  {
    title: "viridis",
    url: "./graphics/colormap/viridis.html",
    path: "./graphics/colormap/viridis.html",
    content: "Viridis colormap array.",
  },
  {
    title: "white",
    url: "./graphics/colormap/white.html",
    path: "./graphics/colormap/white.html",
    content: "white colormap array.",
  },
  {
    title: "winter",
    url: "./graphics/colormap/winter.html",
    path: "./graphics/colormap/winter.html",
  ...
  },
  {
    ...
    content: "Validate that all elements are within a specified range.",
  },
  {
    title: "mustBeColumn",
  ...
  },
  {
    ...
    content:
      "The Debugger module in Nelson provides functions to inspect and analyze program execution. It is designed to help users identify errors, trace the flow of execution, and better understand the state of variables during runtime. Text editor support debugging features integrate with these functions to provide a seamless debugging experience.",
  },
  {
    title: "dbclear",
    url: "./debugger/dbclear.html",
    path: "./debugger/dbclear.html",
    content: "Remove breakpoints during debugging.",
  },
  {
    title: "dbcont",
    url: "./debugger/dbcont.html",
    path: "./debugger/dbcont.html",
    content: "Resume execution from a paused breakpoint.",
  },
  {
    title: "dbdown",
    url: "./debugger/dbdown.html",
    path: "./debugger/dbdown.html",
    content: "Move down the call stack in debug mode.",
  },
  {
    title: "dbquit",
    url: "./debugger/dbquit.html",
    path: "./debugger/dbquit.html",
    content: "Quit debug mode.",
  },
  {
    title: "dbstack",
  ...
  },
  {
    ...
    content: "List all breakpoints during debugging.",
  },
  {
    title: "dbstep",
    url: "./debugger/dbstep.html",
    path: "./debugger/dbstep.html",
    content: "Execute next executable line during debugging.",
  },
  {
    title: "dbstop",
    url: "./debugger/dbstop.html",
    path: "./debugger/dbstop.html",
    content: "Set breakpoints for debugging.",
  },
  {
    title: "dbup",
    url: "./debugger/dbup.html",
    path: "./debugger/dbup.html",
    content: "Move up the call stack in debug mode.",
  },
  {
  ...
  },
  {
    ...
    content: "Checks unresolved cross-references in Nelson help XML files.",
  },
  {
    title: "xmldoctohelp",
